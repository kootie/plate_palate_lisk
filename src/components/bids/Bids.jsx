          ...
          <div className="card-column" >
            <div className="bids-card">
              <div className="bids-card-top">
                <img src={bids1} alt="" />
              <Link to={`/post/123`}>
              <p className="bids-title">Ugali Saucer</p>
              </Link>
              </div>
              <div className="bids-card-bottom">
                <p>0.001125 <span>ETH</span></p>
                <p> <AiFillHeart /> 92</p>
              </div>
            </div>
          </div>
          <div className="card-column" >
            <div className="bids-card">
              <div className="bids-card-top">
                <img src={bids2} alt="" />
              <Link to={`/post/123`}>
              <p className="bids-title">Oven Fried Chicken</p>
              </Link>
              </div>
              <div className="bids-card-bottom">
          ...
          <div className="card-column" >
            <div className="bids-card">
              <div className="bids-card-top">
                <img src={bids3} alt="" />
              <Link to={`/post/123`}>
              <p className="bids-title">Chapati Vegeterian</p>
              </Link>
              </div>
              <div className="bids-card-bottom">
          ...
          <div className="card-column" >
            <div className="bids-card">
              <div className="bids-card-top">
                <img src={bids4} alt="" />
              <Link to={`/post/123`}>
              <p className="bids-title">Chicken Mushroom</p>
              </Link>
              </div>
              <div className="bids-card-bottom">
          ...
          <div className="card-column" >
            <div className="bids-card">
              <div className="bids-card-top">
                <img src={bids5} alt="" />
              <Link to={`/post/123`}>
              <p className="bids-title">Lamb Stew</p>
              </Link>
              </div>
              <div className="bids-card-bottom">
          ...
          <div className="card-column" >
            <div className="bids-card">
              <div className="bids-card-top">
                <img src={bids6} alt="" />
              <Link to={`/post/123`}>
              <p className="bids-title">Beef Choma Stew</p>
              </Link>
              </div>
              <div className="bids-card-bottom">
